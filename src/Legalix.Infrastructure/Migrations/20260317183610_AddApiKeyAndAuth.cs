...
{
    /// <inheritdoc />
    public partial class AddApiKeyAndAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VirtualCards_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionAudits_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionAudits_VirtualCards_VirtualCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_VirtualCards_VirtualCardId",
                        column: x => x.VirtualCardId,
                        principalTable: "VirtualCards",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_VirtualCardId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionAudits_CompanyId",
                table: "TransactionAudits",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionAudits_VirtualCardId",
                table: "TransactionAudits",
                column: "VirtualCardId");

            migrationBuilder.CreateIndex(
                name: "IX_VirtualCards_CompanyId",
                table: "VirtualCards",
                column: "CompanyId");
